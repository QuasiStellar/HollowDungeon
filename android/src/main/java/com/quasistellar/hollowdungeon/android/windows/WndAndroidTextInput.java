...
package com.quasistellar.hollowdungeon.android.windows;
...
public class WndAndroidTextInput extends com.quasistellar.hollowdungeon.ui.Window {
	...
	public WndAndroidTextInput(final String title, final String initialValue, final int maxLength,
		...
		final RenderedTextBlock txtTitle = com.quasistellar.hollowdungeon.scenes.PixelScene.renderTextBlock( title, 9 );
		txtTitle.maxWidth( width );
		txtTitle.hardlight( Window.TITLE_COLOR );
		txtTitle.setPos( (width - txtTitle.width()) /2, 2);
		add(txtTitle);
		
		final com.quasistellar.hollowdungeon.ui.RedButton positiveBtn = new com.quasistellar.hollowdungeon.ui.RedButton( posTxt ) {
			@Override
		...
		final com.quasistellar.hollowdungeon.ui.RedButton negativeBtn;
		if (negTxt != null) {
