...
package com.quasistellar.shatteredpixeldungeon.ui;
...
import com.quasistellar.shatteredpixeldungeon.sprites.HeroSprite;
import com.quasistellar.shatteredpixeldungeon.windows.WndGame;
import com.quasistellar.shatteredpixeldungeon.windows.WndHero;
import com.quasistellar.shatteredpixeldungeon.windows.WndJournal;
import com.quasistellar.shatteredpixeldungeon.Assets;
import com.quasistellar.shatteredpixeldungeon.Dungeon;
import com.quasistellar.shatteredpixeldungeon.SPDAction;
...
public class StatusPane extends Component {
	...
	private com.quasistellar.shatteredpixeldungeon.ui.BossHealthBar bossHP;
	...
	private com.quasistellar.shatteredpixeldungeon.ui.DangerIndicator danger;
	private com.quasistellar.shatteredpixeldungeon.ui.BuffIndicator buffs;
	private com.quasistellar.shatteredpixeldungeon.ui.Compass compass;
	...
	protected void createChildren() {
		...
		add( new Button(){
			...
			protected void onClick () {
				...
				com.quasistellar.shatteredpixeldungeon.scenes.GameScene.show( new WndHero() );
			}
		...
		avatar = com.quasistellar.shatteredpixeldungeon.sprites.HeroSprite.avatar( Dungeon.hero.heroClass, lastTier );
		add( avatar );
		...
		level = new BitmapText( com.quasistellar.shatteredpixeldungeon.scenes.PixelScene.pixelFont);
		level.hardlight( 0xFFEBA4 );
		add( level );

		depth = new BitmapText( Integer.toString( Dungeon.depth ), com.quasistellar.shatteredpixeldungeon.scenes.PixelScene.pixelFont);
		...
		version = new BitmapText( "v" + Game.version, com.quasistellar.shatteredpixeldungeon.scenes.PixelScene.pixelFont);
		version.alpha( 0.5f );
		add(version);
	}
	...
	protected void layout() {
		...
		com.quasistellar.shatteredpixeldungeon.scenes.PixelScene.align(avatar);

		compass.x = avatar.x + avatar.width / 2f - compass.origin.x;
		compass.y = avatar.y + avatar.height / 2f - compass.origin.y;
		com.quasistellar.shatteredpixeldungeon.scenes.PixelScene.align(compass);
		...
		com.quasistellar.shatteredpixeldungeon.scenes.PixelScene.align(depth);
		...
		version.scale.set(com.quasistellar.shatteredpixeldungeon.scenes.PixelScene.align(0.5f));
		version.measure();
		version.x = width - version.width();
		version.y = btnMenu.bottom() + (4 - version.baseLine());
		com.quasistellar.shatteredpixeldungeon.scenes.PixelScene.align(version);
	}
	...
	public void update() {
		...
		if (Dungeon.hero.lvl != lastLvl) {
			...
			if (lastLvl != -1) {
				...
				emitter.revive();
				emitter.pos( 27, 27 );
				emitter.burst( com.quasistellar.shatteredpixeldungeon.effects.Speck.factory( Speck.STAR ), 12 );
			}
			...
			com.quasistellar.shatteredpixeldungeon.scenes.PixelScene.align(level);
		}
	...
	private static class JournalButton extends Button {
		...
		private com.quasistellar.shatteredpixeldungeon.ui.KeyDisplay keyIcon;
		...
		protected void layout() {
			...
			com.quasistellar.shatteredpixeldungeon.scenes.PixelScene.align(journalIcon);
		...
		protected void onClick() {
			...
			com.quasistellar.shatteredpixeldungeon.scenes.GameScene.show( new WndJournal() );
		}
