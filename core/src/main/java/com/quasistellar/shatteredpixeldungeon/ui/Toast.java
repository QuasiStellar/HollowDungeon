...
import com.quasistellar.shatteredpixeldungeon.Chrome;
...
public class Toast extends Component {
	...
	protected com.quasistellar.shatteredpixeldungeon.ui.SimpleButton close;
	...
	protected void createChildren() {
		...
		close = new SimpleButton( com.quasistellar.shatteredpixeldungeon.ui.Icons.get( Icons.CLOSE ) ) {
		...
		text = com.quasistellar.shatteredpixeldungeon.scenes.PixelScene.renderTextBlock(8);
		add( text );
	}
	...
	protected void layout() {
		...
		com.quasistellar.shatteredpixeldungeon.scenes.PixelScene.align(close);
