...
package com.quasistellar.shatteredpixeldungeon.levels.builders;

import com.quasistellar.shatteredpixeldungeon.levels.rooms.connection.ConnectionRoom;
import com.quasistellar.shatteredpixeldungeon.levels.builders.Builder;
import com.quasistellar.shatteredpixeldungeon.levels.rooms.Room;
	...
	public ArrayList<Room> build(ArrayList<Room> rooms) {
		...
		for (int i = 0; i <= roomsOnPath; i++){
			...
			for (int j = 0; j < tunnels; j++){
				com.quasistellar.shatteredpixeldungeon.levels.rooms.connection.ConnectionRoom t = ConnectionRoom.createRoom();
