...
package com.quasistellar.shatteredpixeldungeon.tiles;
	...
	protected int getTileVisual(int pos, int tile, boolean flat){
		...
		if (DungeonTileSheet.wallStitcheable(tile)) {
			if (pos + mapWidth < size && !DungeonTileSheet.wallStitcheable(map[pos + mapWidth])){
				...
				if (map[pos + mapWidth] == com.quasistellar.shatteredpixeldungeon.levels.Terrain.DOOR){
					return DungeonTileSheet.DOOR_SIDEWAYS;
				} else if (map[pos + mapWidth] == com.quasistellar.shatteredpixeldungeon.levels.Terrain.LOCKED_DOOR){
					return DungeonTileSheet.DOOR_SIDEWAYS_LOCKED;
				} else if (map[pos + mapWidth] == com.quasistellar.shatteredpixeldungeon.levels.Terrain.OPEN_DOOR){
		...
		} else if (Dungeon.level.insideMap(pos) && (map[pos+mapWidth] == com.quasistellar.shatteredpixeldungeon.levels.Terrain.DOOR || map[pos+mapWidth] == com.quasistellar.shatteredpixeldungeon.levels.Terrain.LOCKED_DOOR) ) {
			return DungeonTileSheet.DOOR_OVERHANG;
		} else if (Dungeon.level.insideMap(pos) && map[pos+mapWidth] == com.quasistellar.shatteredpixeldungeon.levels.Terrain.OPEN_DOOR ) {
			return DungeonTileSheet.DOOR_OVERHANG_OPEN;
		} else if (pos + mapWidth < size && (map[pos+mapWidth] == com.quasistellar.shatteredpixeldungeon.levels.Terrain.STATUE || map[pos+mapWidth] == com.quasistellar.shatteredpixeldungeon.levels.Terrain.STATUE_SP)){
			return DungeonTileSheet.STATUE_OVERHANG;
		} else if (pos + mapWidth < size && map[pos+mapWidth] == com.quasistellar.shatteredpixeldungeon.levels.Terrain.ALCHEMY){
			return DungeonTileSheet.ALCHEMY_POT_OVERHANG;
		} else if (pos + mapWidth < size && map[pos+mapWidth] == com.quasistellar.shatteredpixeldungeon.levels.Terrain.BARRICADE){
			return DungeonTileSheet.BARRICADE_OVERHANG;
		} else if (pos + mapWidth < size && map[pos+mapWidth] == com.quasistellar.shatteredpixeldungeon.levels.Terrain.HIGH_GRASS){
