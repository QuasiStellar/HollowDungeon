...
import com.quasistellar.shatteredpixeldungeon.sprites.DM200Sprite;
...
public class DM200 extends Mob {

	{
		...
		loot = Random.oneOf(com.quasistellar.shatteredpixeldungeon.items.Generator.Category.WEAPON, com.quasistellar.shatteredpixeldungeon.items.Generator.Category.ARMOR);
	...
	public void rollToDropLoot() {
		...
		lootChance *= Math.pow(1/2f, com.quasistellar.shatteredpixeldungeon.Dungeon.LimitedDrops.DM200_EQUIP.count);
	...
	protected Item createLoot() {
		...
		if (loot == com.quasistellar.shatteredpixeldungeon.items.Generator.Category.WEAPON){
			return com.quasistellar.shatteredpixeldungeon.items.Generator.randomWeapon(4);
		} else {
	...
	protected boolean act() {
		...
		com.quasistellar.shatteredpixeldungeon.scenes.GameScene.add(com.quasistellar.shatteredpixeldungeon.actors.blobs.Blob.seed(pos, 0, com.quasistellar.shatteredpixeldungeon.actors.blobs.ToxicGas.class));
		ventCooldown--;
		return super.act();
	}
	...
	private void zap( ){
		...
		for (int i : trajectory.subPath(0, trajectory.dist)){
			com.quasistellar.shatteredpixeldungeon.scenes.GameScene.add(com.quasistellar.shatteredpixeldungeon.actors.blobs.Blob.seed(i, 20, com.quasistellar.shatteredpixeldungeon.actors.blobs.ToxicGas.class));
		}
