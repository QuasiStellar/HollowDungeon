...
package com.quasistellar.shatteredpixeldungeon.items.weapon.enchantments;
...
public class Blazing extends Weapon.Enchantment {
	...
	private static com.quasistellar.shatteredpixeldungeon.sprites.ItemSprite.Glowing ORANGE = new com.quasistellar.shatteredpixeldungeon.sprites.ItemSprite.Glowing( 0xFF4400 );
	
	@Override
	public int proc(Weapon weapon, com.quasistellar.shatteredpixeldungeon.actors.Char attacker, Char defender, int damage ) {
		// lvl 0 - 33%
		// lvl 1 - 50%
		// lvl 2 - 60%
