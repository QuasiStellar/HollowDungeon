...
import com.quasistellar.shatteredpixeldungeon.effects.particles.PurpleParticle;
...
public class Stylus extends com.quasistellar.shatteredpixeldungeon.items.Item {
	...
	public void execute( Hero hero, String action ) {
		...
		if (action.equals(AC_INSCRIBE)) {
			...
			curUser = hero;
			GameScene.selectItem( itemSelector, com.quasistellar.shatteredpixeldungeon.windows.WndBag.Mode.ARMOR, Messages.get(this, "prompt") );
	...
	private void inscribe( Armor armor ) {
		...
		if (!armor.isIdentified() ){
			com.quasistellar.shatteredpixeldungeon.utils.GLog.w( Messages.get(this, "identify"));
			return;
	...
	private final com.quasistellar.shatteredpixeldungeon.windows.WndBag.Listener itemSelector = new WndBag.Listener() {
		@Override
