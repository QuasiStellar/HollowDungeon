...
package com.quasistellar.shatteredpixeldungeon.items.bombs;
...
public class Noisemaker extends Bomb {
	...
	public void setTrigger(int cell){
		...
		com.quasistellar.shatteredpixeldungeon.actors.buffs.Buff.affect(com.quasistellar.shatteredpixeldungeon.Dungeon.hero, Trigger.class).set(cell);

		com.quasistellar.shatteredpixeldungeon.effects.CellEmitter.center( cell ).start( com.quasistellar.shatteredpixeldungeon.effects.Speck.factory( com.quasistellar.shatteredpixeldungeon.effects.Speck.SCREAM ), 0.3f, 3 );
		Sample.INSTANCE.play( com.quasistellar.shatteredpixeldungeon.Assets.Sounds.ALERT );
	...
	public static class Trigger extends Buff {
		...
		public void set(int cell){
			floor = com.quasistellar.shatteredpixeldungeon.Dungeon.depth;
			this.cell = cell;
			left = 6;
		}
		...
		public boolean act() {
			...
			if (com.quasistellar.shatteredpixeldungeon.Dungeon.depth != floor){
				spend(com.quasistellar.shatteredpixeldungeon.actors.Actor.TICK);
				return true;
			}

			Noisemaker bomb = null;
			Heap heap = com.quasistellar.shatteredpixeldungeon.Dungeon.level.heaps.get(cell);
			...
			if (bomb == null) {
				...
				if (left <= 0){
					CellEmitter.center( cell ).start( com.quasistellar.shatteredpixeldungeon.effects.Speck.factory( Speck.SCREAM ), 0.3f, 3 );
					Sample.INSTANCE.play( Assets.Sounds.ALERT );

					for (com.quasistellar.shatteredpixeldungeon.actors.mobs.Mob mob : Dungeon.level.mobs.toArray( new Mob[0] )) {
						mob.beckon( cell );
					}
					left = 6;
				}
