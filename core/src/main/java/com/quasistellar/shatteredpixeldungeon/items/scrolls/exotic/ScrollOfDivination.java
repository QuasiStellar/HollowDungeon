...
public class ScrollOfDivination extends ExoticScroll {
	...
	public void doRead() {
		...
		ArrayList<com.quasistellar.shatteredpixeldungeon.items.Item> IDed = new ArrayList<>();
		int left = 4;
	...
	private class WndDivination extends Window {
		...
		WndDivination(ArrayList<com.quasistellar.shatteredpixeldungeon.items.Item> IDed ){
			com.quasistellar.shatteredpixeldungeon.windows.IconTitle cur = new com.quasistellar.shatteredpixeldungeon.windows.IconTitle(new ItemSprite(ScrollOfDivination.this),
