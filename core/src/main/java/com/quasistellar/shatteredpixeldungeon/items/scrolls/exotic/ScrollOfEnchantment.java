...
import com.quasistellar.shatteredpixeldungeon.effects.Enchanting;
...
import com.quasistellar.shatteredpixeldungeon.windows.WndOptions;
...
import com.quasistellar.shatteredpixeldungeon.items.stones.StoneOfEnchantment;
...
public class ScrollOfEnchantment extends ExoticScroll {
	...
	public void doRead() {
		...
		com.quasistellar.shatteredpixeldungeon.scenes.GameScene.selectItem( itemSelector, com.quasistellar.shatteredpixeldungeon.windows.WndBag.Mode.ENCHANTABLE, Messages.get(this, "inv_title"));
	}
	...
	protected com.quasistellar.shatteredpixeldungeon.windows.WndBag.Listener itemSelector = new WndBag.Listener() {
		...
		public void onSelect(final Item item) {
			...
			if (item instanceof Weapon){
				...
				com.quasistellar.shatteredpixeldungeon.scenes.GameScene.show(new com.quasistellar.shatteredpixeldungeon.windows.WndOptions(Messages.titleCase(ScrollOfEnchantment.this.name()),
					...
					protected void onSelect(int index) {
						if (index < 3) {
							...
							com.quasistellar.shatteredpixeldungeon.utils.GLog.p(Messages.get(StoneOfEnchantment.class, "weapon"));
							((ScrollOfEnchantment) Item.curItem).readAnimation();
							
							Sample.INSTANCE.play( com.quasistellar.shatteredpixeldungeon.Assets.Sounds.READ );
							Invisibility.dispel();
							com.quasistellar.shatteredpixeldungeon.effects.Enchanting.show(Item.curUser, item);
						}
					}
