...
package com.quasistellar.shatteredpixeldungeon.items.potions.exotic;

import com.quasistellar.shatteredpixeldungeon.Dungeon;
import com.quasistellar.shatteredpixeldungeon.items.Item;
import com.quasistellar.shatteredpixeldungeon.items.Recipe;
...
import com.quasistellar.shatteredpixeldungeon.items.potions.PotionOfExperience;
import com.quasistellar.shatteredpixeldungeon.items.potions.PotionOfFrost;
import com.quasistellar.shatteredpixeldungeon.items.potions.PotionOfHaste;
...
import com.quasistellar.shatteredpixeldungeon.items.potions.PotionOfLevitation;
...
import com.quasistellar.shatteredpixeldungeon.items.potions.PotionOfParalyticGas;
import com.quasistellar.shatteredpixeldungeon.items.potions.PotionOfPurity;
import com.quasistellar.shatteredpixeldungeon.items.potions.PotionOfStrength;
import com.quasistellar.shatteredpixeldungeon.items.potions.PotionOfToxicGas;
...
public class ExoticPotion extends Potion {
	...
	public void setKnown() {
		if (!isKnown()) {
			...
			Potion p = com.quasistellar.shatteredpixeldungeon.Dungeon.hero.belongings.getItem(getClass());
	...
	public static class PotionToExotic extends Recipe {
		...
		@Override
		public boolean testIngredients(ArrayList<com.quasistellar.shatteredpixeldungeon.items.Item> ingredients) {
			int s = 0;
			Potion p = null;
			
			for (com.quasistellar.shatteredpixeldungeon.items.Item i : ingredients){
		...
		@Override
		public int cost(ArrayList<com.quasistellar.shatteredpixeldungeon.items.Item> ingredients) {
			return 0;
		}
		
		@Override
		public com.quasistellar.shatteredpixeldungeon.items.Item brew(ArrayList<com.quasistellar.shatteredpixeldungeon.items.Item> ingredients) {
			com.quasistellar.shatteredpixeldungeon.items.Item result = null;
		...
		@Override
		public com.quasistellar.shatteredpixeldungeon.items.Item sampleOutput(ArrayList<com.quasistellar.shatteredpixeldungeon.items.Item> ingredients) {
