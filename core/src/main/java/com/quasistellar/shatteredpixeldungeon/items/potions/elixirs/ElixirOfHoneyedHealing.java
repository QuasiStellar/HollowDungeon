...
package com.quasistellar.shatteredpixeldungeon.items.potions.elixirs;
...
import com.quasistellar.shatteredpixeldungeon.actors.buffs.Healing;
import com.quasistellar.shatteredpixeldungeon.actors.buffs.Hunger;
import com.quasistellar.shatteredpixeldungeon.actors.hero.Hero;
import com.quasistellar.shatteredpixeldungeon.actors.mobs.Bee;
...
public class ElixirOfHoneyedHealing extends Elixir {
	...
	public void shatter(int cell) {
		...
		com.quasistellar.shatteredpixeldungeon.actors.Char ch = Actor.findChar(cell);
		if (ch != null){
	...
	public static class Recipe extends com.quasistellar.shatteredpixeldungeon.items.Recipe.SimpleRecipe {
