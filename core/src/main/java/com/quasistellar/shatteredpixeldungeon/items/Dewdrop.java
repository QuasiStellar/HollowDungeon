...
public class Dewdrop extends Item {
	...
	public boolean doPickUp( Hero hero ) {
		...
		com.quasistellar.shatteredpixeldungeon.items.DewVial vial = hero.belongings.getItem( DewVial.class );
		...
		if (vial != null && !vial.isFull()){
			...
			if (effect > 0) {
				hero.HP += effect;
				hero.sprite.emitter().burst( com.quasistellar.shatteredpixeldungeon.effects.Speck.factory( Speck.HEALING ), 1 );
