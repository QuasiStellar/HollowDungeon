...
public class v0_1_X_Changes {
	...
	public static void addAllChanges( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		...
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo( "v0.1.X", true, "");
	...
	public static void add_v0_1_1_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.1.1", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(new Ankh()), "Revival Item Changes",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.SCROLL_BERKANAN, null), "Misc Item Changes",
				"Sungrass buffed:\n" +
	...
	public static void add_v0_1_0_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new ChangeInfo("v0.1.0", false, "");
		changes.hardlight(com.quasistellar.hollowdungeon.ui.Window.TITLE_COLOR);
		changeInfos.add(changes);
		
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(com.quasistellar.hollowdungeon.ui.Icons.SHPX), "Developer Commentary",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.SEED_EARTHROOT, null), "Seed Changes",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.POTION_SILVER, null), "Potion Changes",
		...
		changes.addButton( new ChangeButton(new ItemSprite(com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.SCROLL_BERKANAN, null), "Scroll Changes",
