...
public class ChangeInfo extends Component {
	...
	private com.quasistellar.hollowdungeon.ui.RenderedTextBlock title;
	public boolean major;
	
	private RenderedTextBlock text;
	
	private ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeButton> buttons = new ArrayList<>();
	...
	public void addButton( com.quasistellar.hollowdungeon.ui.changelist.ChangeButton button ){
		buttons.add(button);
		add(button);
	...
	public boolean onClick( float x, float y ){
		for( com.quasistellar.hollowdungeon.ui.changelist.ChangeButton button : buttons){
	...
	protected void layout() {
		...
		com.quasistellar.hollowdungeon.scenes.PixelScene.align( title );
		posY += title.height() + 2;
		...
		float posX = x;
		float tallest = 0;
		for (com.quasistellar.hollowdungeon.ui.changelist.ChangeButton change : buttons){
