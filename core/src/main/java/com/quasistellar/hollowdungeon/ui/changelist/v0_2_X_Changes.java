...
public class v0_2_X_Changes {
	...
	public static void addAllChanges( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		...
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo( "v0.2.X", true, "");
		...
		changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo(" ", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
	}
	
	public static void add_v0_2_4_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.2.4", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.BANDOLIER, null), "New Content",
	...
	public static void add_v0_2_3_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.2.3", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.POTION_CRIMSON, null), "Balance Changes",
	...
	public static void add_v0_2_2_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.2.2", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.STONE_AUGMENTATION, null), "Pixel Dungeon v1.7.2",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Environment.TERRAIN_FEATURES, 112, 112, 16, 16), "New Plants",
	...
	public static void add_v0_2_1_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.2.1", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Sprites.GHOST, 0, 0, 14, 15), "New Sewer Quests",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(com.quasistellar.hollowdungeon.Assets.Sprites.GOO, 43, 3, 14, 11), "Goo Changes",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.GUIDE_PAGE, null), "Story & Signpost Changes",
				"Most text in the sewers has been overhauled, including descriptions, quest dialogues, signposts, and story scrolls"));
	}
	
	public static void add_v0_2_0_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new ChangeInfo("v0.2.0", false, "");
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new ItemSprite(com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.RING_DIAMOND, null), "New Rings!",
