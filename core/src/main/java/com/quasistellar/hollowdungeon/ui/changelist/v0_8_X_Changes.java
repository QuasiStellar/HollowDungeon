...
public class v0_8_X_Changes {
	...
	public static void add_v0_8_1_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.8.1", true, "");
		changes.hardlight( Window.TITLE_COLOR );
		changeInfos.add(changes);

		changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo( "", false, null);
		changes.hardlight( Window.TITLE_COLOR );
		changeInfos.add(changes);

		changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo( "v0.8.1a", false, null);
		changes.hardlight( Window.TITLE_COLOR );
		changeInfos.add(changes);

		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(Icons.AUDIO), "Sound Effect Adjustments",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(Icons.DISPLAY), "New Hero Select!",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(Icons.AUDIO), "Sound Effects",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Interfaces.BUFFS_LARGE, 0, 0, 16, 16), "Item and Buff Icons",
		...
		changes.hardlight( com.quasistellar.hollowdungeon.sprites.CharSprite.WARNING );
		changeInfos.add(changes);

		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.POUCH), "Item Droprate and Inventory Managment",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Sprites.TENGU, 0, 0, 14, 16), "Boss Changes",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(Icons.DISPLAY), "Interface Adjustments",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.RING_AMETHYST), "Ring of Wealth and Lucky Enchant",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton( new Image(Assets.Sprites.KNIGHT, 0, 0, 14, 20), "Assassin and Sniper",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.WAND_DISINTEGRATION), "Various Item Buffs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.WAND_CORRUPTION), "Various Item Nerfs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.GREATAXE), "Various Weapon Nerfs",
	...
	public static void add_v0_8_0_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.8.0", true, "");
		changes.hardlight( Window.TITLE_COLOR );
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(new com.quasistellar.hollowdungeon.sprites.DM100Sprite()), "Misc Enemies",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(new com.quasistellar.hollowdungeon.sprites.ShamanSprite.Purple()), "Caves",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(new com.quasistellar.hollowdungeon.sprites.ElementalSprite.Frost()), "Dwarven City",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(new com.quasistellar.hollowdungeon.sprites.SpawnerSprite()), "Demon Halls",
		...
		i = new Image(new com.quasistellar.hollowdungeon.sprites.YogSprite());
		i.scale.set(0.8f);
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(i, "Yog-Dzewa",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Environment.TERRAIN_FEATURES, 64, 96, 16, 16), "Trap Adjustments",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.ARMOR_WARRIOR), "Weapon and Armor Changes",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(new com.quasistellar.hollowdungeon.sprites.StatueSprite()), "AI Tweaks",
		...
		if (DeviceCompat.isDesktop()) {
			changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton( Icons.get( Icons.LIBGDX ), "LibGDX Desktop Functionality",
			...
			changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton( new com.quasistellar.hollowdungeon.sprites.ItemSprite(com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.SCROLL_TIWAZ, null), "Update Notification",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(com.quasistellar.hollowdungeon.ui.Icons.PREFS), Messages.get(com.quasistellar.hollowdungeon.scenes.ChangesScene.class, "misc"),
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(new com.quasistellar.hollowdungeon.sprites.NecromancerSprite()), "Necromancers",
		...
		changes.addButton( new ChangeButton(new Image(new com.quasistellar.hollowdungeon.sprites.GuardSprite()), "Enemy Nerfs",
