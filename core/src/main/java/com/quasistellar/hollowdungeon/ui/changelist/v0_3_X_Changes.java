...
public class v0_3_X_Changes {
	...
	public static void addAllChanges( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		...
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo( "v0.3.X", true, "");
	...
	public static void add_v0_3_5_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.3.5", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
	...
	public static void add_v0_3_4_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.3.4", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(Icons.LANGS), "Translations!",
	...
	public static void add_v0_3_3_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.3.3", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(Icons.PREFS), "Google Play Games",
	...
	public static void add_v0_3_2_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.3.2", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Sprites.TENGU, 0, 0, 14, 16), "Prison Rework",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.MASTERY, null), "Balance Changes",
	...
	public static void add_v0_3_1_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.3.1", false, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Environment.TERRAIN_FEATURES, 112, 96, 16, 16), "Trap Overhaul",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Interfaces.MENU, 15, 0, 16, 15), "Interface Improvements",
	...
	public static void add_v0_3_0_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new ChangeInfo("v0.3.0", false, "");
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new ItemSprite(com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.WAND_DISINTEGRATION, null), "Wand Rework!",
				"Removed Wands:\n" +
