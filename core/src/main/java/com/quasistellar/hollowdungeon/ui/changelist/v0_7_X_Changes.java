...
public class v0_7_X_Changes {
	...
	public static void addAllChanges( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
	...
	public static void add_v0_7_5_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.7.5", true, "");
		changes.hardlight( Window.TITLE_COLOR );
		changeInfos.add(changes);
		
		changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo(Messages.get(com.quasistellar.hollowdungeon.scenes.ChangesScene.class, "new"), false, null);
		changes.hardlight( Window.TITLE_COLOR );
		changeInfos.add(changes);
		
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(Icons.SHPX), "Developer Commentary",
				"_-_ Released October 2nd, 2019\n" +
				"_-_ 76 days after Shattered v0.7.4\n" +
				"\n" +
				"Dev commentary will be added here in the future."));
		
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Sprites.SNAKE, 12, 0, 12, 11), "Sewer Enemies",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Sprites.TENGU, 0, 0, 14, 16), "Prison Enemies",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(Icons.LIBGDX), "LibGDX Text Rendering!",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Sprites.RAT, 0, 15, 16, 15), "Enemy Changes",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(Icons.PREFS), Messages.get(com.quasistellar.hollowdungeon.scenes.ChangesScene.class, "misc"),
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Sprites.SPINNER, 144, 0, 16, 16), Messages.get(com.quasistellar.hollowdungeon.scenes.ChangesScene.class, "bugfixes"),
				"Fixed:\n" +
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(Icons.LANGS), Messages.get(com.quasistellar.hollowdungeon.scenes.ChangesScene.class, "language"),
				"Added new Language: Japanese!\n\n" +
				"Updated Translations and Translator Credits!"));
		
		changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo(Messages.get(com.quasistellar.hollowdungeon.scenes.ChangesScene.class, "buffs"), false, null);
		changes.hardlight( CharSprite.POSITIVE );
		changeInfos.add(changes);
		
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.WAND_BLAST_WAVE, null), "Wand Buffs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.RING_AMETHYST, null), "Ring Buffs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.LONGSWORD, new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing( 0x440066 )), "Glyph/Enchant Buffs",
	...
	public static void add_v0_7_4_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.7.4", true, "");
		changes.hardlight( Window.TITLE_COLOR );
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(Icons.LIBGDX), "LibGDX",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.EXOTIC_BERKANAN), "Ally AI improvements",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.NOISEMAKER, null), "Enhanced Bomb Buffs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.LONGSWORD, new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing(0xFF4400)), "Enchant/Glyph Buffs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.WILD_ENERGY, null), "Misc Item Buffs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.ARMOR_MAIL, new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing(0x88EEFF)), "Glyph Nerfs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.ARCANE_BOMB, null), "Enhanced Bomb Nerfs",
	...
	public static void add_v0_7_3_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.7.3", true, "");
		changes.hardlight( Window.TITLE_COLOR );
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.LONGSWORD, new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing(0xFFFF00)), "Enchantment Changes",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.KUNAI, null), "New Thrown Weapons",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.ELIXIR_ARCANE, null), "New Boss Recipes",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.CURSE_INFUSE, null), "Boss Recipe Buffs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.RING_EMERALD, null), "Other Item Buffs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.ARMOR_SCALE, new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing( 0x663300 )), "Enchant/Glyph Buffs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton( new Image(Assets.Environment.TERRAIN_FEATURES, 16, 0, 16, 16), "Trap Adjustments!",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.ARMOR_PLATE, new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing( 0x660022 )), "Enchant/Glyph Nerfs",
	...
	public static void add_v0_7_2_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.7.2", true, "");
		changes.hardlight( Window.TITLE_COLOR );
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.POTION_CATALYST, null), "Catalysts!",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.LONGSWORD, new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing(0x0000FF)), "Enchantment Overhaul!",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.MAGIC_INFUSE, null), "Enchantment Adjustments",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.BREW_INFERNAL, null), "Combination Items",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.SPEAR, new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing(0x00FFFF)), "Buffed Enchants",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.SEED_SWIFTTHISTLE, null), "Item Balance Adjustments",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.DIRK, new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing(0xFF4400)), "Nerfed Enchants",
	...
	public static void add_v0_7_1_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.7.1", true, "");
		changes.hardlight( Window.TITLE_COLOR );
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton( new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.TRIDENT, null), "Thrown Weapon Improvements",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(BadgeBanner.image(Badges.Badge.UNLOCK_MAGE.image), "Hero Class changes",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton( new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.RING_TOPAZ, null), "Various Item Buffs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton( new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.ARMOR_LEATHER, new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing(0x222222)), "Other Buffs",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Sprites.KING, 1, 0, 14, 16), "Dwarf King",
	...
	public static void add_v0_7_0_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo("v0.7.0", true, "");
		changes.hardlight( Window.TITLE_COLOR );
		changeInfos.add(changes);
		
		changes = new com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo(Messages.get(com.quasistellar.hollowdungeon.scenes.ChangesScene.class, "new"), false, null);
		changes.hardlight( com.quasistellar.hollowdungeon.ui.Window.TITLE_COLOR );
		changeInfos.add(changes);
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Environment.TILES_SEWERS, 48, 96, 16, 16 ), "Alchemy Overhaul!",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(Assets.Environment.TERRAIN_FEATURES, 32, 112, 16, 16), "New Consumables",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.STONE_BLINK, null), "Runestones",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.EXOTIC_AMBER, null), "Exotic Potions",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.EXOTIC_ISAZ, null), "Exotic Scrolls",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.RETURN_BEACON, null), "New Recipes!",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.ARTIFACT_ARMBAND, null), "Spawn Rate Changes",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(ItemSpriteSheet.ARTIFACT_BEACON, null), "Boss reward changes",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new Image(com.quasistellar.hollowdungeon.Assets.Sprites.SPINNER, 144, 0, 16, 16), Messages.get(com.quasistellar.hollowdungeon.scenes.ChangesScene.class, "bugfixes"),
				"Fixed:\n" +
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(Icons.get(com.quasistellar.hollowdungeon.ui.Icons.LANGS), Messages.get(com.quasistellar.hollowdungeon.scenes.ChangesScene.class, "language"),
