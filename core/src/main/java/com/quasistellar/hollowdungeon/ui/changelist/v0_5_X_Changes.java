...
public class v0_5_X_Changes {
	...
	public static void add_v0_5_0_Changes( ArrayList<com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo> changeInfos ){
		com.quasistellar.hollowdungeon.ui.changelist.ChangeInfo changes = new ChangeInfo("v0.5.0", true, "");
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton( Icons.get(Icons.DEPTH), "New Dungeon Visual Style!",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new com.quasistellar.hollowdungeon.sprites.ItemSprite(new Quarterstaff()), "Equipment Balance Changes",
		...
		changes.addButton( new com.quasistellar.hollowdungeon.ui.changelist.ChangeButton(new ItemSprite(new Glaive()), "Glyph Balance Changes",
		...
		changes.addButton( new ChangeButton(Icons.get(com.quasistellar.hollowdungeon.ui.Icons.LANGS), Messages.get(ChangesScene.class, "language"),
