...
public class Sungrass extends com.quasistellar.hollowdungeon.plants.Plant {
	...
	public static class Health extends Buff {
		...
		public boolean act() {
			...
			if (partialHeal > 1){
				...
				target.sprite.emitter().burst(Speck.factory(com.quasistellar.hollowdungeon.effects.Speck.HEALING), 1);
