...
import com.quasistellar.hollowdungeon.windows.WndBadge;
...
public class BadgesScene extends PixelScene {
	...
	public void create() {
		...
		if (badges.contains(Badges.Badge.YASD)) 				blankBadges -= 2;
	...
	private static class BadgeButton extends Button {
		...
		public void update() {
			...
			if (Random.Float() < Game.elapsed * 0.1) {
				com.quasistellar.hollowdungeon.effects.BadgeBanner.highlight( icon, badge.image );
			}
		}
