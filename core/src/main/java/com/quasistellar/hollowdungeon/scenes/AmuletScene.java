...
public class AmuletScene extends PixelScene {
	...
	public void update() {
		...
		if ((timer -= Game.elapsed) < 0) {
			...
			com.quasistellar.hollowdungeon.effects.Speck star = (com.quasistellar.hollowdungeon.effects.Speck)recycle( com.quasistellar.hollowdungeon.effects.Speck.class );
