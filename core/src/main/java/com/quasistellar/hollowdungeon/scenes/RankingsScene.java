...
import com.quasistellar.hollowdungeon.windows.WndRanking;
...
public class RankingsScene extends PixelScene {
	...
	public static class Record extends Button {
		...
		protected com.quasistellar.hollowdungeon.sprites.ItemSprite shield;
		private com.quasistellar.hollowdungeon.effects.Flare flare;
		...
		protected void createChildren() {
			...
			shield = new ItemSprite( com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.TOMB, null );
			add( shield );
