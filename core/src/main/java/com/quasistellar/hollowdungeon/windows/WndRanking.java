...
import com.quasistellar.hollowdungeon.ui.BadgesList;
...
public class WndRanking extends WndTabbed {
	...
	private class StatsTab extends Group {
		...
		public StatsTab() {
			...
			title.label( Messages.get(this, "title", 0, heroClass ).toUpperCase( Locale.ENGLISH ) );
			...
			pos = statSlot( this, Messages.get(this, "str"), Integer.toString( 0 ), pos );
	...
	private class ItemButton extends Button {
		...
		@Override
		protected void onClick() {
			Game.scene().add( new com.quasistellar.hollowdungeon.windows.WndInfoItem( item ) );
		}
	}
