...
public class WndInfoItem extends Window {
	...
	private void fillFields( Heap heap ) {
		...
		com.quasistellar.hollowdungeon.windows.IconTitle titlebar = new com.quasistellar.hollowdungeon.windows.IconTitle( heap );
	...
	private void fillFields( Item item ) {
		...
		com.quasistellar.hollowdungeon.windows.IconTitle titlebar = new com.quasistellar.hollowdungeon.windows.IconTitle( item );
