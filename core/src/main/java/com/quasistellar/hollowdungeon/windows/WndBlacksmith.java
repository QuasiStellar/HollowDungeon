...
public class WndBlacksmith extends Window {
	...
	public WndBlacksmith( Blacksmith troll, Hero hero ) {
		...
		btnItem1 = new ItemButton() {
			...
			protected void onClick() {
				btnPressed = btnItem1;
				GameScene.selectItem( itemSelector, com.quasistellar.hollowdungeon.windows.WndBag.Mode.UPGRADEABLE, Messages.get(WndBlacksmith.class, "select") );
			}
		};
	...
	protected com.quasistellar.hollowdungeon.windows.WndBag.Listener itemSelector = new WndBag.Listener() {
		@Override
