...
import com.quasistellar.hollowdungeon.levels.CityLevel;
import com.quasistellar.hollowdungeon.sprites.ImpSprite;
import com.quasistellar.hollowdungeon.windows.WndImp;
...
public class Imp extends NPC {
	...
	private void tell( String text ) {
		Game.runOnRenderThread(new Callback() {
			@Override
			public void call() {
				com.quasistellar.hollowdungeon.scenes.GameScene.show( new WndQuest( Imp.this, text ));
			}
		});
	}
		...
		public static void process( Mob mob ) {
			if (spawned && given && !completed) {
				if ((alternative && mob instanceof Monk) ||
					...
					com.quasistellar.hollowdungeon.Dungeon.level.drop( new DwarfToken(), mob.pos ).sprite.drop();
				}
			}
		}
