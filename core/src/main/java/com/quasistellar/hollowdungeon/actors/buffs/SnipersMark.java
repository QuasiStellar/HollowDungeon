...
public class SnipersMark extends FlavourBuff implements com.quasistellar.hollowdungeon.ui.ActionIndicator.Action {
	...
	public void detach() {
		super.detach();
		com.quasistellar.hollowdungeon.ui.ActionIndicator.clearAction(this);
	}
	...
	public void doAction() {
		...
		com.quasistellar.hollowdungeon.actors.Char ch = (Char) Actor.findById(object);
		if (ch == null) return;
