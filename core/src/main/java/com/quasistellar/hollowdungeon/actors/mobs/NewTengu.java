...
import com.quasistellar.hollowdungeon.levels.NewPrisonBossLevel;
...
public class NewTengu extends com.quasistellar.hollowdungeon.actors.mobs.Mob {
	...
	public void add(com.quasistellar.hollowdungeon.actors.buffs.Buff buff) {
		if (Actor.chars().contains(this) || buff instanceof com.quasistellar.hollowdungeon.actors.buffs.Doom){
			super.add(buff);
		}
	}
	...
	public void damage(int dmg, Object src) {
		...
		com.quasistellar.hollowdungeon.levels.NewPrisonBossLevel.State state = ((com.quasistellar.hollowdungeon.levels.NewPrisonBossLevel) Dungeon.level).state();
		...
		if (HP == 0 && state == NewPrisonBossLevel.State.FIGHT_ARENA) {
			...
			Actor.add(new com.quasistellar.hollowdungeon.actors.Actor() {
				...
				protected boolean act() {
					Actor.remove(this);
					((com.quasistellar.hollowdungeon.levels.NewPrisonBossLevel) Dungeon.level).progress();
					return true;
				}
			});
			return;
	...
	private void jump() {
		...
		int newPos;
		if (Dungeon.level instanceof com.quasistellar.hollowdungeon.levels.NewPrisonBossLevel){
			com.quasistellar.hollowdungeon.levels.NewPrisonBossLevel level = (com.quasistellar.hollowdungeon.levels.NewPrisonBossLevel) Dungeon.level;
			...
			if (level.state() == NewPrisonBossLevel.State.FIGHT_START) {
				...
				do {
					newPos = ((com.quasistellar.hollowdungeon.levels.NewPrisonBossLevel) Dungeon.level).randomTenguCellPos();
				} while ( level.trueDistance(newPos, enemy.pos) <= 3.5f
						|| level.trueDistance(newPos, Dungeon.hero.pos) <= 3.5f
						|| Actor.findChar(newPos) != null);
				
				if (level.heroFOV[pos]) com.quasistellar.hollowdungeon.effects.CellEmitter.get( pos ).burst( com.quasistellar.hollowdungeon.effects.Speck.factory( com.quasistellar.hollowdungeon.effects.Speck.WOOL ), 6 );
				
				sprite.move( pos, newPos );
				move( newPos );
				
				if (level.heroFOV[newPos]) com.quasistellar.hollowdungeon.effects.CellEmitter.get( newPos ).burst( com.quasistellar.hollowdungeon.effects.Speck.factory( com.quasistellar.hollowdungeon.effects.Speck.WOOL ), 6 );
	...
	private static com.quasistellar.hollowdungeon.actors.Char throwingChar;
	...
	public static boolean throwBomb(final com.quasistellar.hollowdungeon.actors.Char thrower, final com.quasistellar.hollowdungeon.actors.Char target){
		...
		((com.quasistellar.hollowdungeon.sprites.MissileSprite) thrower.sprite.parent.recycle(com.quasistellar.hollowdungeon.sprites.MissileSprite.class)).
	...
	public static class BombAbility extends com.quasistellar.hollowdungeon.actors.buffs.Buff {
		...
		public boolean act() {
			...
			if (timer == 3) {
				com.quasistellar.hollowdungeon.effects.FloatingText.show(p.x, p.y, bombPos, "3...", CharSprite.NEUTRAL);
				...
				com.quasistellar.hollowdungeon.effects.FloatingText.show(p.x, p.y, bombPos, "2...", CharSprite.WARNING);
			} else if (timer == 1){
				com.quasistellar.hollowdungeon.effects.FloatingText.show(p.x, p.y, bombPos, "1...", com.quasistellar.hollowdungeon.sprites.CharSprite.NEGATIVE);
			} else {
				com.quasistellar.hollowdungeon.items.Heap h = Dungeon.level.heaps.get(bombPos);
				if (h != null){
					for (com.quasistellar.hollowdungeon.items.Item i : h.items.toArray(new com.quasistellar.hollowdungeon.items.Item[0])){
		...
		public static class BombBlob extends com.quasistellar.hollowdungeon.actors.blobs.Blob {
			{
				...
				for (int i = area.left; i < area.right; i++){
					for (int j = area.top; j < area.bottom; j++){
						...
						if (cur[cell] > 0 && off[cell] == 0){
							...
							if (h != null){
								for (com.quasistellar.hollowdungeon.items.Item it : h.items.toArray(new com.quasistellar.hollowdungeon.items.Item[0])){
			...
			@Override
			public void use(com.quasistellar.hollowdungeon.effects.BlobEmitter emitter) {
				super.use(emitter);
		...
		public static class BombItem extends com.quasistellar.hollowdungeon.items.Item {
			...
			protected void onThrow(int cell) {
				...
				if (throwingChar != null){
					com.quasistellar.hollowdungeon.actors.buffs.Buff.append(throwingChar, BombAbility.class).bombPos = cell;
					throwingChar = null;
				} else {
					com.quasistellar.hollowdungeon.actors.buffs.Buff.append(curUser, BombAbility.class).bombPos = cell;
				}
			}
			...
			public Emitter emitter() {
				...
				emitter.pour(com.quasistellar.hollowdungeon.effects.particles.SmokeParticle.SPEW, 0.05f);
				return emitter;
			}
		}
	}
	...
	public static boolean throwFire(final com.quasistellar.hollowdungeon.actors.Char thrower, final com.quasistellar.hollowdungeon.actors.Char target){
		...
		for (int i = 0; i < PathFinder.CIRCLE8.length; i++){
			if (aim.sourcePos+PathFinder.CIRCLE8[i] == aim.path.get(1)){
				...
				com.quasistellar.hollowdungeon.actors.buffs.Buff.append(thrower, NewTengu.FireAbility.class).direction = i;
				
				thrower.sprite.emitter().start(com.quasistellar.hollowdungeon.effects.Speck.factory(com.quasistellar.hollowdungeon.effects.Speck.STEAM), .03f, 10);
				return true;
			}
		}
	...
	public static class FireAbility extends com.quasistellar.hollowdungeon.actors.buffs.Buff {
		...
		public static class FireBlob extends com.quasistellar.hollowdungeon.actors.blobs.Blob {
					...
					for (int j = area.top; j < area.bottom; j++){
						...
						if (cur[cell] > 0 && off[cell] == 0){
							...
							if (ch != null && !ch.isImmune(Fire.class) && !(ch instanceof NewTengu)) {
								com.quasistellar.hollowdungeon.actors.buffs.Buff.affect( ch, com.quasistellar.hollowdungeon.actors.buffs.Burning.class ).reignite( ch );
							}
							...
							burned = true;
							com.quasistellar.hollowdungeon.effects.CellEmitter.get(cell).start(FlameParticle.FACTORY, 0.03f, 10);
						}
					}
				}
			...
			public void use(com.quasistellar.hollowdungeon.effects.BlobEmitter emitter) {
				...
				emitter.pour( com.quasistellar.hollowdungeon.effects.Speck.factory( com.quasistellar.hollowdungeon.effects.Speck.STEAM ), 0.2f );
			}
	...
	public static boolean throwShocker(final com.quasistellar.hollowdungeon.actors.Char thrower, final com.quasistellar.hollowdungeon.actors.Char target){
		...
		thrower.sprite.zap(finalTargetCell);
		((com.quasistellar.hollowdungeon.sprites.MissileSprite) thrower.sprite.parent.recycle(MissileSprite.class)).
				reset(thrower.sprite,
						finalTargetCell,
						item,
						new Callback() {
	...
	public static class ShockerAbility extends com.quasistellar.hollowdungeon.actors.buffs.Buff {
		...
		public boolean act() {
			...
			if (shockingOrdinals == null){
				...
				target.sprite.parent.add(new com.quasistellar.hollowdungeon.effects.Lightning(shockerPos - 1 - Dungeon.level.width(), shockerPos + 1 + Dungeon.level.width(), null));
				target.sprite.parent.add(new com.quasistellar.hollowdungeon.effects.Lightning(shockerPos - 1 + Dungeon.level.width(), shockerPos + 1 - Dungeon.level.width(), null));
				...
				target.sprite.parent.add(new com.quasistellar.hollowdungeon.effects.Lightning(shockerPos - Dungeon.level.width(), shockerPos + Dungeon.level.width(), null));
				target.sprite.parent.add(new com.quasistellar.hollowdungeon.effects.Lightning(shockerPos - 1, shockerPos + 1, null));
		...
		private void spreadblob(){
			...
			for (int i = shockingOrdinals ? 0 : 1; i < PathFinder.CIRCLE8.length; i += 2){
				if (!Dungeon.level.solid[shockerPos+PathFinder.CIRCLE8[i]]) {
					com.quasistellar.hollowdungeon.scenes.GameScene.add(Blob.seed(shockerPos + PathFinder.CIRCLE8[i], 2, ShockerBlob.class));
				}
			}
		}
		...
		public static class ShockerBlob extends com.quasistellar.hollowdungeon.actors.blobs.Blob {
		...
		public static class ShockerItem extends Item {
			
			{
				...
				image = com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.TENGU_SHOCKER;
			}
			
			@Override
			public boolean doPickUp( Hero hero ) {
				com.quasistellar.hollowdungeon.utils.GLog.w( Messages.get(this, "cant_pickup") );
				return false;
			}
			...
			protected void onThrow(int cell) {
				...
				if (throwingChar != null){
					...
					com.quasistellar.hollowdungeon.actors.buffs.Buff.append(curUser, ShockerAbility.class).shockerPos = cell;
				}
			}
			...
			public Emitter emitter() {
				...
				emitter.pos(5, 5);
				emitter.fillTarget = false;
				emitter.pour(com.quasistellar.hollowdungeon.effects.particles.SparkParticle.FACTORY, 0.1f);
				return emitter;
			}
		}
