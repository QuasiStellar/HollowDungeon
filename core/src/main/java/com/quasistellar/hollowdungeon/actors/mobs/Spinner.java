...
import com.quasistellar.hollowdungeon.sprites.SpinnerSprite;
...
public class Spinner extends com.quasistellar.hollowdungeon.actors.mobs.Mob {
	...
	protected boolean act() {
		...
		if (state == FLEEING && buff( com.quasistellar.hollowdungeon.actors.buffs.Terror.class ) == null &&
				enemy != null && enemySeen && enemy.buff( com.quasistellar.hollowdungeon.actors.buffs.Poison.class ) == null) {
			state = HUNTING;
		}
		return result;
	}
	...
	public int attackProc(Char enemy, int damage) {
		...
		if (Random.Int(2) == 0) {
			Buff.affect(enemy, com.quasistellar.hollowdungeon.actors.buffs.Poison.class).set(Random.Int(7, 9) );
			webCoolDown = 0;
			state = FLEEING;
		}
	...
	public void shootWeb(){
		...
		if (enemy != null && webPos != enemy.pos && webPos != -1){
			...
			if (Dungeon.level.passable[leftPos]) GameScene.add(Blob.seed(leftPos, 20, com.quasistellar.hollowdungeon.actors.blobs.Web.class));
			if (Dungeon.level.passable[webPos])  GameScene.add(Blob.seed(webPos, 20, com.quasistellar.hollowdungeon.actors.blobs.Web.class));
			if (Dungeon.level.passable[rightPos])
                com.quasistellar.hollowdungeon.scenes.GameScene.add(com.quasistellar.hollowdungeon.actors.blobs.Blob.seed(rightPos, 20, com.quasistellar.hollowdungeon.actors.blobs.Web.class));
