	...
	private static ArrayList<Class<? extends Mob>> standardMobRotation( int depth ){
		switch(depth){
			...
			case 11:
				...
				return new ArrayList<>(Arrays.asList(
						com.quasistellar.hollowdungeon.actors.mobs.Bat.class, com.quasistellar.hollowdungeon.actors.mobs.Bat.class, com.quasistellar.hollowdungeon.actors.mobs.Bat.class,
						com.quasistellar.hollowdungeon.actors.mobs.Brute.class,
						Shaman.random()));
			case 12:
				//2x bat, 2x brute, 1x shaman, 1x spinner
				return new ArrayList<>(Arrays.asList(
						com.quasistellar.hollowdungeon.actors.mobs.Bat.class, com.quasistellar.hollowdungeon.actors.mobs.Bat.class,
						com.quasistellar.hollowdungeon.actors.mobs.Brute.class, com.quasistellar.hollowdungeon.actors.mobs.Brute.class,
						Shaman.random(),
						Spinner.class));
			case 13:
				//1x bat, 2x brute, 2x shaman, 2x spinner, 1x DM-200
				return new ArrayList<>(Arrays.asList(
						com.quasistellar.hollowdungeon.actors.mobs.Bat.class,
						com.quasistellar.hollowdungeon.actors.mobs.Brute.class, com.quasistellar.hollowdungeon.actors.mobs.Brute.class,
