...
public class Buff extends Actor {
	...
	public static<T extends Buff> T append(com.quasistellar.hollowdungeon.actors.Char target, Class<T> buffClass ) {
		T buff = Reflection.newInstance(buffClass);
		buff.attachTo( target );
		return buff;
	}

	public static<T extends FlavourBuff> T append(com.quasistellar.hollowdungeon.actors.Char target, Class<T> buffClass, float duration ) {
	...
	public static<T extends Buff> T affect(com.quasistellar.hollowdungeon.actors.Char target, Class<T> buffClass ) {
	...
	public static<T extends FlavourBuff> T affect(com.quasistellar.hollowdungeon.actors.Char target, Class<T> buffClass, float duration ) {
	...
	public static<T extends FlavourBuff> T prolong(com.quasistellar.hollowdungeon.actors.Char target, Class<T> buffClass, float duration ) {
		T buff = affect( target, buffClass );
