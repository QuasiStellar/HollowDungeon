...
public class WellFed extends Buff {
	...
	public void reset(){
		...
		left = (int) com.quasistellar.hollowdungeon.actors.buffs.Hunger.STARVING;
	}
	...
	public float iconFadePercent() {
		return Math.max(0, (com.quasistellar.hollowdungeon.actors.buffs.Hunger.STARVING - left) / Hunger.STARVING);
	}
