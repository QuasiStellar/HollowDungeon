...
public class Healing extends Buff {
	...
	
	{
		...
		actPriority = com.quasistellar.hollowdungeon.actors.Actor.HERO_PRIO - 1;
	...
	public void fx(boolean on) {
		...
		else    target.sprite.remove( com.quasistellar.hollowdungeon.sprites.CharSprite.State.HEALING );
	}
