...
public class FalseKnightMaggot2 extends Mob {
    ...
    public void die(Object cause) {
        super.die(cause);
        FalseKnight3 falseKnight3;
        falseKnight3 = new FalseKnight3();
        falseKnight3.pos = this.pos;
        GameScene.add( falseKnight3 );
        Dungeon.level.occupyCell( falseKnight3 );
