...
public class HDSettings extends GameSettings {
	...
	public static void visualGrid( int value ){
		put( KEY_GRID, value );
		com.quasistellar.hollowdungeon.scenes.GameScene.updateMap();
	}
	...
	public static void language(com.quasistellar.hollowdungeon.messages.Languages lang) {
		put( KEY_LANG, lang.code());
	}
	
	public static com.quasistellar.hollowdungeon.messages.Languages language() {
	...
	public static boolean systemFont(){
		return getBoolean(KEY_SYSTEMFONT,
				(language() == Languages.KOREAN || language() == Languages.CHINESE || language() == com.quasistellar.hollowdungeon.messages.Languages.JAPANESE));
	}
