...
import com.quasistellar.hollowdungeon.levels.rooms.sewerboss.SewerBossEntranceRoom;
import com.quasistellar.hollowdungeon.levels.rooms.sewerboss.SewerBossExitRoom;
...
public class SewerBossLevel extends HallownestLevel {
	...
	public Group addVisuals() {
		super.addVisuals();
		if (map[exit-1] != Terrain.WALL_DECO) visuals.add(new com.quasistellar.hollowdungeon.levels.PrisonLevel.Torch(exit-1));
