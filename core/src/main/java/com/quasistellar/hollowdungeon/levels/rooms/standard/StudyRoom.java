...
public class StudyRoom extends StandardRoom {
	...
	public void paint(Level level) {
		...
		Point center = center();
		Painter.set( level, center, com.quasistellar.hollowdungeon.levels.Terrain.PEDESTAL );
		...
		if (prize != null) {
			...
			level.drop(Generator.random( Random.oneOf(
					...
					com.quasistellar.hollowdungeon.items.Generator.Category.SCROLL)), (center.x + center.y * level.width()));
		}
	}
}
