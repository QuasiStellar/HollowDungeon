...
public abstract class RegularPainter extends com.quasistellar.hollowdungeon.levels.painters.Painter {
	...
	@Override
	public boolean paint(com.quasistellar.hollowdungeon.levels.Level level, ArrayList<Room> rooms) {
	...
	protected abstract void decorate(com.quasistellar.hollowdungeon.levels.Level level, ArrayList<Room> rooms);
	...
	protected void paintDoors(com.quasistellar.hollowdungeon.levels.Level l, ArrayList<Room> rooms ) {
		for (Room r : rooms) {
			for (Room n : r.connected.keySet()) {
...
//					}
	...
	protected boolean joinRooms(com.quasistellar.hollowdungeon.levels.Level l, Room r, Room n ) {
		
		if (!(r instanceof com.quasistellar.hollowdungeon.levels.rooms.standard.EmptyRoom && n instanceof EmptyRoom)) {
			return false;
		}
		...
		if (w.left == w.right) {
			...
			com.quasistellar.hollowdungeon.levels.painters.Painter.fill( l, w.left, w.top, 1, w.height(), Terrain.EMPTY );
	...
	protected void paintWater(com.quasistellar.hollowdungeon.levels.Level l, ArrayList<Room> rooms ){
	...
	protected void paintGrass(com.quasistellar.hollowdungeon.levels.Level l, ArrayList<Room> rooms ) {
		boolean[] grass = com.quasistellar.hollowdungeon.levels.Patch.generate( l.width(), l.height(), grassFill, grassSmoothness, true );
	...
	protected void paintTraps(com.quasistellar.hollowdungeon.levels.Level l, ArrayList<Room> rooms ) {
		...
		for (int i = 0; i < nTraps; i++) {
			...
			l.map[trapPos] = trap.visible ? Terrain.TRAP : com.quasistellar.hollowdungeon.levels.Terrain.SECRET_TRAP;
		}
	}
