...
public class PillarsRoom extends StandardRoom {
	...
	public void paint(Level level) {
		...
		//4 pillars
			...
			Painter.fill(level, left + 1 + pillarInset, bottom - pillarSize - pillarInset - Math.round(percentSkew*ySpaces), pillarSize, pillarSize, com.quasistellar.hollowdungeon.levels.Terrain.WALL);
