...
public abstract class Painter {
	...
	public abstract boolean paint(com.quasistellar.hollowdungeon.levels.Level level, ArrayList<Room> rooms);
	
	// Static methods

	public static void set(com.quasistellar.hollowdungeon.levels.Level level, int cell, int value ) {
		level.map[cell] = value;
	}
	
	public static void set(com.quasistellar.hollowdungeon.levels.Level level, int x, int y, int value ) {
		set( level, x + y * level.width(), value );
	}
	
	public static void set(com.quasistellar.hollowdungeon.levels.Level level, Point p, int value ) {
		set( level, p.x, p.y, value );
	}
	
	public static void fill(com.quasistellar.hollowdungeon.levels.Level level, int x, int y, int w, int h, int value ) {
	...
	public static void fill(com.quasistellar.hollowdungeon.levels.Level level, Rect rect, int value ) {
		fill( level, rect.left, rect.top, rect.width(), rect.height(), value );
	}
	
	public static void fill(com.quasistellar.hollowdungeon.levels.Level level, Rect rect, int m, int value ) {
		fill( level, rect.left + m, rect.top + m, rect.width() - m*2, rect.height() - m*2, value );
	}
	
	public static void fill(com.quasistellar.hollowdungeon.levels.Level level, Rect rect, int l, int t, int r, int b, int value ) {
		fill( level, rect.left + l, rect.top + t, rect.width() - (l + r), rect.height() - (t + b), value );
	}
	
	public static void drawLine(com.quasistellar.hollowdungeon.levels.Level level, Point from, Point to, int value){
		float x = from.x;
		float y = from.y;
	...
	public static void fillEllipse(com.quasistellar.hollowdungeon.levels.Level level, Rect rect, int value ) {
		fillEllipse( level, rect.left, rect.top, rect.width(), rect.height(), value );
	}

	public static void fillEllipse(com.quasistellar.hollowdungeon.levels.Level level, Rect rect, int m, int value ) {
		fillEllipse( level, rect.left + m, rect.top + m, rect.width() - m*2, rect.height() - m*2, value );
	}
	
	public static void fillEllipse(com.quasistellar.hollowdungeon.levels.Level level, int x, int y, int w, int h, int value){
	...
	public static void fillDiamond(com.quasistellar.hollowdungeon.levels.Level level, Rect rect, int value ) {
		fillDiamond( level, rect.left, rect.top, rect.width(), rect.height(), value );
	}

	public static void fillDiamond(com.quasistellar.hollowdungeon.levels.Level level, Rect rect, int m, int value ) {
		fillDiamond( level, rect.left + m, rect.top + m, rect.width() - m*2, rect.height() - m*2, value );
	}

	public static void fillDiamond(com.quasistellar.hollowdungeon.levels.Level level, int x, int y, int w, int h, int value){
