...
public abstract class SpecialRoom extends Room {
	...
	private static final ArrayList<Class<? extends SpecialRoom>> ALL_SPEC = new ArrayList<>( Arrays.asList(
			...
			TreasuryRoom.class, TrapsRoom.class, StorageRoom.class, com.quasistellar.hollowdungeon.levels.rooms.special.StatueRoom.class, VaultRoom.class, com.quasistellar.hollowdungeon.levels.rooms.special.RunestoneRoom.class
	) );
