...
import com.quasistellar.hollowdungeon.actors.mobs.YogDzewa;
...
public class NewHallsBossLevel extends Level {
	...
	public void unseal() {
		...
		com.quasistellar.hollowdungeon.scenes.GameScene.updateMap( exit );

		CellEmitter.get(exit-1).burst(ShadowParticle.UP, 25);
		CellEmitter.get(exit).burst(ShadowParticle.UP, 100);
		com.quasistellar.hollowdungeon.effects.CellEmitter.get(exit+1).burst(ShadowParticle.UP, 25);
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(com.quasistellar.hollowdungeon.levels.HallsLevel.class, "water_name");
			case Terrain.GRASS:
				return Messages.get(com.quasistellar.hollowdungeon.levels.HallsLevel.class, "grass_name");
			case Terrain.HIGH_GRASS:
				return Messages.get(com.quasistellar.hollowdungeon.levels.HallsLevel.class, "high_grass_name");
			case Terrain.STATUE:
			case Terrain.STATUE_SP:
				return Messages.get(com.quasistellar.hollowdungeon.levels.HallsLevel.class, "statue_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(com.quasistellar.hollowdungeon.levels.HallsLevel.class, "water_desc");
			case Terrain.STATUE:
			case Terrain.STATUE_SP:
				return Messages.get(com.quasistellar.hollowdungeon.levels.HallsLevel.class, "statue_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(com.quasistellar.hollowdungeon.levels.HallsLevel.class, "bookshelf_desc");
			default:
