...
import com.quasistellar.hollowdungeon.actors.buffs.MagicalSight;
...
public abstract class Level implements Bundlable {
	...
	public SparseArray<com.quasistellar.hollowdungeon.plants.Plant> plants;
...
//		}
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		for (Bundlable p : collection) {
			com.quasistellar.hollowdungeon.plants.Plant plant = (com.quasistellar.hollowdungeon.plants.Plant)p;
	...
	public Heap drop( Item item, int cell ) {
		...
		if (item == null){
			...
			Heap heap = new Heap();
			com.quasistellar.hollowdungeon.sprites.ItemSprite sprite = heap.sprite = new ItemSprite();
			sprite.link(heap);
			return heap;
	...
	public boolean setCellToWater( boolean includeTraps, int cell ){
		...
		if (terr == Terrain.EMPTY || terr == Terrain.GRASS ||
			...
			com.quasistellar.hollowdungeon.scenes.GameScene.updateMap(cell);
			return true;
		}
