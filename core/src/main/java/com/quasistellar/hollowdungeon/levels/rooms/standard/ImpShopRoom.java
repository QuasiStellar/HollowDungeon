...
import com.quasistellar.hollowdungeon.actors.mobs.npcs.ImpShopkeeper;
...
public class ImpShopRoom extends ShopRoom {
	...
	protected void placeShopkeeper(com.quasistellar.hollowdungeon.levels.Level level) {
		...
		for (Point p : getPoints()){
			if (level.map[level.pointToCell(p)] == com.quasistellar.hollowdungeon.levels.Terrain.PEDESTAL){
	...
	public void spawnShop(com.quasistellar.hollowdungeon.levels.Level level){
		impSpawned = true;
