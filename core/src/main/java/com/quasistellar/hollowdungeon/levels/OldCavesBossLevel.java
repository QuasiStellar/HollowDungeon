...
public class OldCavesBossLevel extends Level {
	...
	public Heap drop( Item item, int cell ) {
		...
		if (!keyDropped && item instanceof SkeletonKey) {
			...
			com.quasistellar.hollowdungeon.effects.CellEmitter.get( arenaDoor ).start( Speck.factory( com.quasistellar.hollowdungeon.effects.Speck.ROCK ), 0.07f, 10 );
			
			set( arenaDoor, Terrain.EMPTY_DECO );
			com.quasistellar.hollowdungeon.scenes.GameScene.updateMap( arenaDoor );
			Dungeon.observe();
		}
	...
	public String tileDesc( int tile ) {
		switch (tile) {
			...
			case Terrain.EXIT:
				return Messages.get(com.quasistellar.hollowdungeon.levels.CavesLevel.class, "exit_desc");
			case Terrain.HIGH_GRASS:
