...
public class Lightning extends Group {
	...
	public static class Arc extends Group {
		...
		public Arc(PointF from, PointF to){
			...
			arc1 = new Image(com.quasistellar.hollowdungeon.effects.Effects.get(com.quasistellar.hollowdungeon.effects.Effects.Type.LIGHTNING));
			arc1.x = start.x - arc1.origin.x;
			arc1.y = start.y - arc1.origin.y;
			arc1.origin.set( 0, arc1.height()/2 );
			add( arc1 );

			arc2 = new Image(com.quasistellar.hollowdungeon.effects.Effects.get(Effects.Type.LIGHTNING));
