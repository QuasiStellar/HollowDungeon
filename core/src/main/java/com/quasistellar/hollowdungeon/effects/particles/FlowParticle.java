...
public class FlowParticle extends PixelParticle {
	...
	public static class Flow extends Group {
		...
		public void update() {
			...
			if (visible = (pos < Dungeon.level.heroFOV.length && com.quasistellar.hollowdungeon.Dungeon.level.heroFOV[pos])) {
				...
				if ((delay -= Game.elapsed) <= 0) {
					...
					((FlowParticle)recycle( FlowParticle.class )).reset(
						x + Random.Float( com.quasistellar.hollowdungeon.tiles.DungeonTilemap.SIZE ), y );
				}
			}
		}
	}
