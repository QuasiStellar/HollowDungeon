...
public class EmoIcon extends Image {
	...
	protected com.quasistellar.hollowdungeon.sprites.CharSprite owner;
	
	public EmoIcon( com.quasistellar.hollowdungeon.sprites.CharSprite owner ) {
		super();
	...
	public static class Sleep extends EmoIcon {
		...
		public Sleep( com.quasistellar.hollowdungeon.sprites.CharSprite owner ) {
	...
	public static class Alert extends EmoIcon {
		...
		public Alert( com.quasistellar.hollowdungeon.sprites.CharSprite owner ) {
