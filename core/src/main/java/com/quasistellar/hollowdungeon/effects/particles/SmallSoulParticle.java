...
public class SmallSoulParticle extends PixelParticle.Shrinking {

	public static final Factory FACTORY = new Factory() {
		@Override
		public void emit( Emitter emitter, int index, float x, float y ) {
			((SmallSoulParticle)emitter.recycle( SmallSoulParticle.class )).reset( x, y );
		}
		@Override
