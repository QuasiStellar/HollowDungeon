...
public class TerrainFeaturesTilemap extends com.quasistellar.hollowdungeon.tiles.DungeonTilemap {

	private static TerrainFeaturesTilemap instance;

	private SparseArray<com.quasistellar.hollowdungeon.plants.Plant> plants;
...
//		if (Dungeon.depth == 21 && Dungeon.level instanceof LastShopLevel) stage--;
		if (tile == Terrain.HIGH_GRASS){
			...
			//TODO
			return 11 + 16*stage + (com.quasistellar.hollowdungeon.tiles.DungeonTileSheet.tileVariance[pos] >= 50 ? 1 : 0);
		} else if (tile == Terrain.GRASS) {
			return 13 + 16*stage + (com.quasistellar.hollowdungeon.tiles.DungeonTileSheet.tileVariance[pos] >= 50 ? 1 : 0);
		} else if (tile == com.quasistellar.hollowdungeon.levels.Terrain.EMBERS) {
