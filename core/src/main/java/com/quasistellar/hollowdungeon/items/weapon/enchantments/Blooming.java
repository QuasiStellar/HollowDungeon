...
public class Blooming extends Weapon.Enchantment {
	...
	private static com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing DARK_GREEN = new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing( 0x008800 );
	...
	private boolean plantGrass(int cell){
		...
		if ( c == Terrain.EMPTY || c == Terrain.EMPTY_DECO
			...
			Level.set(cell, com.quasistellar.hollowdungeon.levels.Terrain.HIGH_GRASS);
