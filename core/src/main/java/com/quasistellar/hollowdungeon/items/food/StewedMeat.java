...
public class StewedMeat extends Food {
	...
	public static class oneMeat extends com.quasistellar.hollowdungeon.items.Recipe.SimpleRecipe {
		{
			inputs =  new Class[]{com.quasistellar.hollowdungeon.items.food.MysteryMeat.class};
	...
	public static class twoMeat extends com.quasistellar.hollowdungeon.items.Recipe.SimpleRecipe {
		{
			inputs =  new Class[]{com.quasistellar.hollowdungeon.items.food.MysteryMeat.class};
