...
public class Artifact extends KindofMisc {
	...
	protected com.quasistellar.hollowdungeon.actors.buffs.Buff passiveBuff;
	protected com.quasistellar.hollowdungeon.actors.buffs.Buff activeBuff;
	...
	@Override
	public boolean doEquip( final com.quasistellar.hollowdungeon.actors.hero.Hero hero ) {
	...
	public String info() {
		...
		} else if (!isIdentified() && cursedKnown && !isEquipped( com.quasistellar.hollowdungeon.Dungeon.hero)) {
