...
public class CapeOfThorns extends Artifact {
	...
	public class Thorns extends ArtifactBuff{
		...
		public int proc(int damage, com.quasistellar.hollowdungeon.actors.Char attacker, Char defender){
			if (cooldown == 0){
			...
			if (cooldown != 0){
				...
				if (attacker != null && com.quasistellar.hollowdungeon.Dungeon.level.adjacent(attacker.pos, defender.pos)) {
		...
		public int icon() {
			if (cooldown == 0)
				...
				return com.quasistellar.hollowdungeon.ui.BuffIndicator.THORNS;
		}
