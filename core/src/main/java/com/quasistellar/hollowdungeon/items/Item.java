...
public class Item implements Bundlable {
	...
	private static Comparator<Item> itemComparator = new Comparator<Item>() {
		...
		public int compare( Item lhs, Item rhs ) {
			return com.quasistellar.hollowdungeon.items.Generator.Category.order( lhs ) - Generator.Category.order( rhs );
		}
	};
	...
	public void doThrow( Hero hero ) {
		com.quasistellar.hollowdungeon.scenes.GameScene.selectCell(thrower);
	}
	...
	public static void evoke( Hero hero ) {
		hero.sprite.emitter().burst( Speck.factory( com.quasistellar.hollowdungeon.effects.Speck.EVOKE ), 5 );
	}
	...
	public void cast( final Hero user, final int dst ) {
		...
		if (enemy != null) {
			((com.quasistellar.hollowdungeon.sprites.MissileSprite) user.sprite.parent.recycle(com.quasistellar.hollowdungeon.sprites.MissileSprite.class)).
					reset(user.sprite,
							enemy.sprite,
							this,
							new Callback() {
	...
	protected static com.quasistellar.hollowdungeon.scenes.CellSelector.Listener thrower = new CellSelector.Listener() {
		@Override
