...
public class ChaliceOfBlood extends Artifact {
	...
	private void prick(com.quasistellar.hollowdungeon.actors.hero.Hero hero){
		int damage = 3*(level()*level());

		com.quasistellar.hollowdungeon.plants.Earthroot.Armor armor = hero.buff(Earthroot.Armor.class);
		if (armor != null) {
	...
	public void restoreFromBundle(Bundle bundle) {
		...
		else if (level() >= 3) image = com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.ARTIFACT_CHALICE2;
	}
