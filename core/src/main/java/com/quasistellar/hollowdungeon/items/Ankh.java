...
public class Ankh extends Item {
	...
	public void execute( final Hero hero, String action ) {
		...
		if (action.equals( AC_BLESS )) {
			...
			if (vial != null){
				...
				CellEmitter.get(hero.pos).start(Speck.factory(com.quasistellar.hollowdungeon.effects.Speck.LIGHT), 0.2f, 3);
	...
	private static final com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing WHITE = new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing( 0xFFFFCC );
