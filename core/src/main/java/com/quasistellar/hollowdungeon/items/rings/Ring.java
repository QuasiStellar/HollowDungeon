...
public class Ring extends KindofMisc {
	...
	protected com.quasistellar.hollowdungeon.actors.buffs.Buff buff;
	...
	private static com.quasistellar.hollowdungeon.items.ItemStatusHandler<Ring> handler;
	...
	public static void initGems() {
		handler = new com.quasistellar.hollowdungeon.items.ItemStatusHandler<>( (Class<? extends Ring>[])rings, gems );
	}
	...
	public void anonymize(){
		if (!isKnown()) image = com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.RING_HOLDER;
		anonymous = true;
	}
	...
	public static int getBonus(com.quasistellar.hollowdungeon.actors.Char target, Class<?extends RingBuff> type){
		int bonus = 0;
