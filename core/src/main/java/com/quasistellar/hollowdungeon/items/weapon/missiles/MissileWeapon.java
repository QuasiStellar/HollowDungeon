...
import com.quasistellar.hollowdungeon.items.weapon.enchantments.Projecting;
...
abstract public class MissileWeapon extends Weapon {
	...
	public com.quasistellar.hollowdungeon.items.Item upgrade() {
		if (!bundleRestoring) {
			...
			if (quantity > 1) {
				...
				com.quasistellar.hollowdungeon.items.Item similar = Dungeon.hero.belongings.getSimilar(this);
				if (similar != null){
	...
	@Override
	public float castDelay(com.quasistellar.hollowdungeon.actors.Char user, int dst) {
	...
	protected void decrementDurability(){
		...
		if (parent != null){
			...
			if (durability > 0 && durability <= durabilityPerUse()){
				if (level() <= 0) GLog.w(Messages.get(this, "about_to_break"));
				else             com.quasistellar.hollowdungeon.utils.GLog.n(Messages.get(this, "about_to_break"));
			}
		}
	}
	...
	@Override
	public com.quasistellar.hollowdungeon.items.Item merge(com.quasistellar.hollowdungeon.items.Item other) {
		super.merge(other);
		if (isSimilar(other)) {
	...
	@Override
	public com.quasistellar.hollowdungeon.items.Item split(int amount) {
		bundleRestoring = true;
		com.quasistellar.hollowdungeon.items.Item split = super.split(amount);
	...
	public String info() {
		...
		if (cursed && isEquipped( com.quasistellar.hollowdungeon.Dungeon.hero )) {
