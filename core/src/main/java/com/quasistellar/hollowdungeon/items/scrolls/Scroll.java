...
public abstract class Scroll extends com.quasistellar.hollowdungeon.items.Item {
	...
	protected static com.quasistellar.hollowdungeon.items.ItemStatusHandler<Scroll> handler;
	...
	public static void initLabels() {
		handler = new com.quasistellar.hollowdungeon.items.ItemStatusHandler<>( (Class<? extends Scroll>[])scrolls, runes );
	}
	...
	public static void saveSelectively( Bundle bundle, ArrayList<com.quasistellar.hollowdungeon.items.Item> items ) {
		...
		for (com.quasistellar.hollowdungeon.items.Item i : items){
			if (i instanceof com.quasistellar.hollowdungeon.items.scrolls.exotic.ExoticScroll){
	...
	public static class PlaceHolder extends Scroll {
		...
		{
			image = com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.SCROLL_HOLDER;
		}
		...
		public boolean isSimilar(com.quasistellar.hollowdungeon.items.Item item) {
			return ExoticScroll.regToExo.containsKey(item.getClass())
					|| com.quasistellar.hollowdungeon.items.scrolls.exotic.ExoticScroll.regToExo.containsValue(item.getClass());
		}
