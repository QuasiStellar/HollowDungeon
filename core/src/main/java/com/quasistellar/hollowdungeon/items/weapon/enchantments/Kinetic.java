...
public class Kinetic extends Weapon.Enchantment {
	...
	private static com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing YELLOW = new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing( 0xFFFF00 );
