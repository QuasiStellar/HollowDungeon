...
public class RingOfMight extends Ring {
	...
	@Override
	public boolean doEquip(com.quasistellar.hollowdungeon.actors.hero.Hero hero) {
	...
	private void updateTargetHT(){
		if (buff != null && buff.target instanceof com.quasistellar.hollowdungeon.actors.hero.Hero){
	...
	public static int strengthBonus( com.quasistellar.hollowdungeon.actors.Char target ){
