...
import com.quasistellar.hollowdungeon.windows.WndChooseWay;
...
public class TomeOfMastery extends Item {
	...
	public void choose( HeroSubClass way ) {
		...
		SpellSprite.show( curUser, com.quasistellar.hollowdungeon.effects.SpellSprite.MASTERY );
		curUser.sprite.emitter().burst( Speck.factory( com.quasistellar.hollowdungeon.effects.Speck.MASTERY ), 12 );
