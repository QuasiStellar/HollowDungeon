	...
	public void explode(int cell) {
		...
		for (int i = 0; i < PathFinder.distance.length; i++) {
			if (PathFinder.distance[i] < Integer.MAX_VALUE) {
				if (com.quasistellar.hollowdungeon.Dungeon.level.pit[i])
					GameScene.add(Blob.seed(i, 2, com.quasistellar.hollowdungeon.actors.blobs.Fire.class));
				else
					com.quasistellar.hollowdungeon.scenes.GameScene.add(com.quasistellar.hollowdungeon.actors.blobs.Blob.seed(i, 10, Fire.class));
