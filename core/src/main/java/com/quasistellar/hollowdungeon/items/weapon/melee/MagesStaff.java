...
public class MagesStaff extends MeleeWeapon {
	...
	public com.quasistellar.hollowdungeon.items.Item imbueWand(Wand wand, Char owner){
	...
	private final com.quasistellar.hollowdungeon.windows.WndBag.Listener itemSelector = new com.quasistellar.hollowdungeon.windows.WndBag.Listener() {
		...
		private void applyWand(Wand wand){
			...
			com.quasistellar.hollowdungeon.items.Item.curUser.sprite.emitter().burst( ElmoParticle.FACTORY, 12 );
			com.quasistellar.hollowdungeon.items.Item.evoke(com.quasistellar.hollowdungeon.items.Item.curUser);

			com.quasistellar.hollowdungeon.Dungeon.quickslot.clearItem(wand);

			wand.detach(com.quasistellar.hollowdungeon.items.Item.curUser.belongings.backpack);

			com.quasistellar.hollowdungeon.utils.GLog.p( Messages.get(MagesStaff.class, "imbue", wand.name()));
			imbueWand( wand, com.quasistellar.hollowdungeon.items.Item.curUser );
