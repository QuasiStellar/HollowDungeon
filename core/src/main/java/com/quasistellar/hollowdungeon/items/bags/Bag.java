...
public class Bag extends com.quasistellar.hollowdungeon.items.Item implements Iterable<com.quasistellar.hollowdungeon.items.Item> {
	...
	public void execute(Hero hero, String action ) {
		...
		if (action.equals( AC_OPEN )) {
			...
			GameScene.show( new com.quasistellar.hollowdungeon.windows.WndBag( this, null, WndBag.Mode.ALL, null ) );
	...
	public boolean collect( Bag container ) {
		...
		for (com.quasistellar.hollowdungeon.items.Item item : container.items.toArray( new com.quasistellar.hollowdungeon.items.Item[0] )) {
			if (canHold( item )) {
	...
	public void onDetach( ) {
		...
		for (com.quasistellar.hollowdungeon.items.Item item : items)
			com.quasistellar.hollowdungeon.Dungeon.quickslot.clearItem(item);
		updateQuickslot();
	}
	...
	public void resurrect() {
		for (com.quasistellar.hollowdungeon.items.Item item : items.toArray(new com.quasistellar.hollowdungeon.items.Item[0])){
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		for (Bundlable item : bundle.getCollection( ITEMS )) {
			if (item != null) ((com.quasistellar.hollowdungeon.items.Item)item).collect( this );
		}
	}
	...
	private class ItemIterator implements Iterator<com.quasistellar.hollowdungeon.items.Item> {
		...
		private int index = 0;
		private Iterator<com.quasistellar.hollowdungeon.items.Item> nested = null;
