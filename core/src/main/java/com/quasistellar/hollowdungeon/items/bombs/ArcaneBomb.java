...
public class ArcaneBomb extends com.quasistellar.hollowdungeon.items.bombs.Bomb {
	...
	public void explode(int cell) {
		...
		PathFinder.buildDistanceMap( cell, com.quasistellar.hollowdungeon.utils.BArray.not( Dungeon.level.solid, null ), 2 );
		for (int i = 0; i < PathFinder.distance.length; i++) {
			if (PathFinder.distance[i] < Integer.MAX_VALUE) {
