...
public class Honeypot extends Item {
	...
	public Item shatter(com.quasistellar.hollowdungeon.actors.Char owner, int pos ) {
	...
	public static class ShatteredPot extends Item {
		...
		{
			image = com.quasistellar.hollowdungeon.sprites.ItemSpriteSheet.SHATTPOT;
			stackable = true;
		}
		...
		public void pickupPot(com.quasistellar.hollowdungeon.actors.Char holder){
			for (Bee bee : findBees(holder.pos)){
				updateBee(bee, -1, holder);
			}
		}
		
		public void dropPot(com.quasistellar.hollowdungeon.actors.Char holder, int dropPos ){
		...
		private void updateBee( Bee bee, int cell, com.quasistellar.hollowdungeon.actors.Char holder ){
		...
		private ArrayList<Bee> findBees( com.quasistellar.hollowdungeon.actors.Char potHolder ){
			ArrayList<Bee> bees = new ArrayList<>();
