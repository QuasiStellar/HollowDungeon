...
public class AlchemistsToolkit extends Artifact {
	...
	protected com.quasistellar.hollowdungeon.windows.WndBag.Mode mode = WndBag.Mode.POTION;
	...
	public void execute(com.quasistellar.hollowdungeon.actors.hero.Hero hero, String action ) {
		...
		if (action.equals(AC_BREW)){
			if (!isEquipped(hero))                                          GLog.i( Messages.get(this, "need_to_equip") );
				...
				Game.switchScene(com.quasistellar.hollowdungeon.scenes.AlchemyScene.class);
			}
	...
	public class kitEnergy extends ArtifactBuff implements com.quasistellar.hollowdungeon.scenes.AlchemyScene.AlchemyProvider {
		...
		public void gainCharge(float levelPortion) {
			...
			if (charge < chargeCap) {
				...
				while (partialCharge >= 1) {
					...
					if (charge == chargeCap){
						com.quasistellar.hollowdungeon.utils.GLog.p( Messages.get(AlchemistsToolkit.class, "full") );
						partialCharge = 0;
					}
	...
	public static class upgradeKit extends Recipe {
		...
		public com.quasistellar.hollowdungeon.items.Item sampleOutput(ArrayList<com.quasistellar.hollowdungeon.items.Item> ingredients) {
			...
			sample.absorbEnergy(com.quasistellar.hollowdungeon.scenes.AlchemyScene.availableEnergy());
			return sample;
		}
	}
