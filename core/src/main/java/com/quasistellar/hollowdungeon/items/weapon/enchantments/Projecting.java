...
public class Projecting extends Weapon.Enchantment {
	...
	private static com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing PURPLE = new com.quasistellar.hollowdungeon.sprites.ItemSprite.Glowing( 0x8844CC );
