...
public class RingOfElements extends Ring {
	...
	static {
		RESISTS.add( com.quasistellar.hollowdungeon.actors.buffs.Burning.class );
		RESISTS.add( com.quasistellar.hollowdungeon.actors.buffs.Chill.class );
		RESISTS.add( com.quasistellar.hollowdungeon.actors.buffs.Frost.class );
		RESISTS.add( com.quasistellar.hollowdungeon.actors.buffs.Ooze.class );
		RESISTS.add( com.quasistellar.hollowdungeon.actors.buffs.Paralysis.class );
		RESISTS.add( com.quasistellar.hollowdungeon.actors.buffs.Poison.class );
