...
public class PathFinder {
	...
	public static void setMapSize( int width, int height ) {
		...
		NEIGHBOURS24 = new int[]{-width*2-2, -width*2-1, -width*2, -width*2+1, -width*2+2, -width-2, -width-1, -width, -width+1, -width+2, -2, -1, 1, 2, width-2, width-1, width, width+1, width+2, width*2-2, width*2-1, width*2, width*2+1, width*2+2};
		NEIGHBOURS25 = new int[]{-width*2-2, -width*2-1, -width*2, -width*2+1, -width*2+2, -width-2, -width-1, -width, -width+1, -width+2, -2, -1, 0, 1, 2, width-2, width-1, width, width+1, width+2, width*2-2, width*2-1, width*2, width*2+1, width*2+2};
